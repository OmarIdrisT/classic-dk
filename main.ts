...
mario = sprites.create(assets.image`1`, SpriteKind.Player)
...
let kong = sprites.create(assets.image`2`, SpriteKind.boss)
kong.setPosition(395, 100)
let peach = sprites.create(assets.image`3`, SpriteKind.princess)
